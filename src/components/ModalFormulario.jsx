...
export default function ModalFormulario({
  ...
  const classeLargura = LARGURAS[largura] ?? LARGURAS.padrao;
  ...
  return (
    ...
    >
      <div
        className={`flex w-full flex-col overflow-y-auto bg-white sm:my-8 sm:rounded-2xl sm:shadow-xl ${classeLargura}`}
      >
