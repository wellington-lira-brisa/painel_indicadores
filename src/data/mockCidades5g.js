 ...
 * pelos mesmos helpers (mockHelpers.js). A única diferença de regra de
 * negócio real: onde o FTTH tem "Instalação", o 5G tem "Ativação"
 * (id `ativacao`, nome "Ativação") — os demais indicadores (orçamento,
 * efetivado, churn, cancelamento, crescimento) seguem a mesma taxonomia,
 * só com volumes menores (rollout mais recente que o FTTH).
 *
...
export const cidadesMock5g = [
  {
    ...
    indicadores: [
      indicador('orcamento', 'Orçamento (vendas)', 'abs', true,
        [48, 40, 46, 44, 48, 45, 50, 47, 46, 47, 42, 46],
        [39, 45, 42, 33, 30, 31]),
      indicador('efetivado', 'Efetivado', 'abs', true,
        [40, 34, 39, 38, 41, 37, 43, 42, 42, 42, 42, 42],
        [31, 40, 39, 29, 26, 30]),
  ...
  },
  {
    ...
    indicadores: [
      indicador('orcamento', 'Orçamento (vendas)', 'abs', true,
        [102, 114, 132, 129, 136, 126, 139, 131, 128, 131, 117, 128],
        [113, 106, 128, 132, 126, 112]),
      indicador('efetivado', 'Efetivado', 'abs', true,
        [87, 105, 122, 120, 132, 111, 126, 126, 126, 126, 126, 126],
        [96, 96, 107, 108, 106, 96]),
      indicador('ativacao', 'Ativação', 'abs', true,
  ...
  },
  {
    ...
    indicadores: [
      indicador('orcamento', 'Orçamento (vendas)', 'abs', true,
        [160, 164, 168, 166, 172, 168, 176, 172, 172, 172, 168, 172],
        [164, 170, 172, 168, 178, 175]),
      indicador('efetivado', 'Efetivado', 'abs', true,
        [144, 148, 152, 150, 156, 152, 160, 156, 156, 156, 152, 156],
        [146, 152, 157, 152, 161, 158]),
      indicador('ativacao', 'Ativação', 'abs', true,
  ...
  },
  {
    ...
    indicadores: [
      indicador('orcamento', 'Orçamento (vendas)', 'abs', true,
        [80, 84, 86, 84, 88, 86, 90, 88, 88, 88, 84, 88],
        [70, 73, 76, 71, 74, 70]),
      indicador('efetivado', 'Efetivado', 'abs', true,
        [72, 76, 78, 76, 79, 78, 81, 79, 79, 79, 76, 79],
        [60, 63, 66, 61, 64, 60]),
      indicador('ativacao', 'Ativação', 'abs', true,
  ...
  },
  {
    ...
    indicadores: [
      indicador('orcamento', 'Orçamento (vendas)', 'abs', true,
        [60, 62, 64, 63, 66, 64, 67, 66, 66, 66, 63, 66],
        [55, 52, 60, 54, 57, 51]),
      indicador('efetivado', 'Efetivado', 'abs', true,
        [54, 56, 58, 57, 60, 58, 60, 60, 60, 60, 57, 60],
        [48, 45, 52, 46, 50, 44]),
      indicador('ativacao', 'Ativação', 'abs', true,
  ...
  },
  {
    ...
    indicadores: [
      indicador('orcamento', 'Orçamento (vendas)', 'abs', true,
        [120, 124, 128, 126, 132, 128, 134, 132, 132, 132, 126, 132],
        [114, 118, 124, 119, 127, 122]),
      indicador('efetivado', 'Efetivado', 'abs', true,
        [108, 112, 115, 114, 119, 115, 121, 119, 119, 119, 114, 119],
        [101, 106, 111, 106, 114, 109]),
      indicador('ativacao', 'Ativação', 'abs', true,
